...
class DomainAddView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Create domain
        website.domains.create(domain=s.validated_data.get("domain"))

        # Send signal
        signals.domains_updated.send(sender=website)

        return Response({"message": "The domain has been deleted successfully."})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if website.needs_ssl() or ssl_expiring(website):
            ...
            if activated:
                ...
                return Response({"message": "SSL certificates refresh request has been processed."})
            else:
                return Response(
            ...
            return Response({"message": "SSL certificates have already been installed for this website."})
...
class PhpVersionsView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response({"php_versions": php_versions})
