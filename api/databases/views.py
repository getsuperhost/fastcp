...
class ResetPasswordView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if password:
            ...
            return Response({"message": "Password has been updated.", "new_password": password})
        else:
            return Response(
...
class DatabaseViewSet(viewsets.ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        # Get the database object for any pre-destroy logic if needed
        Database.objects.filter(pk=kwargs.get("pk")).first()
