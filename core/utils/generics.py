...
from core.models import Database, Website
...
def system_stats():
    ...
    return {
        ...
        "disk": {"total": DISK.total, "percent": DISK.percent},
        "stats": {"websites": Website.objects.count(), "databases": Database.objects.count()},
    }
...
def hardware_info():
    ...
    return {
        ...
        "ram": {
            ...
            "swap": {"total": swap.total, "percent": swap.percent},
        },
        "cpu": {
